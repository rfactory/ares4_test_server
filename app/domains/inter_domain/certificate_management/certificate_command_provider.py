...
class CertificateCommandProvider:
    ...
    def create_device_certificate(self, db: Session, *, common_name: str, actor_user: Optional[User] = None) -> Dict:
        """
    ...
    def revoke_certificate(self, db: Session, *, serial_number: str, actor_user: Optional[User] = None) -> bool:
        """
